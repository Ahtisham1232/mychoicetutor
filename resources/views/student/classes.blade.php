                        ...
                        <tbody>
                            @foreach ($classes as $class)
                                @php
                                    ...
                                    $startUtc = $class->start_time
                                        ? \Carbon\Carbon::parse($class->start_time)->setTimezone('UTC')
                                        : null;
                                    $joinWindowEndUtc = $startUtc ? $startUtc->copy()->addMinutes(15) : null;
                                    $inJoinWindow = $startUtc && $joinWindowEndUtc && $nowUtc->gte($startUtc) && $nowUtc->lte($joinWindowEndUtc);
                                    $statusLower = strtolower((string) $class->status);
                                @endphp
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($class->status == 'started' || $class->status == 'Started')
                                            <span class="badge blinking-icon" style="background: red"><i
                                                    class="ri-record-circle-line "></i> Live..</span>
                                    ...
                                    <td>{{ $class->slotdate ? $class->slotdate : '' }}
                                        {{ $class->slottime ? \Carbon\Carbon::parse($class->slottime)->format('h:i A') : '' }}
                                    </td>
