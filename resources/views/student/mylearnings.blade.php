                ...
                <form action="{{ route('student.mylearnings') }}" method="post">
                    ...
                    <div class="row ">
                        <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 mt-4">
                            <input type="text" value="{{ request('topic') }}"  name="topic" class="form-control"
                        ...
                        <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12 mt-4">
                            <div class="myLearningSearch">
                                ...
                                <a href="{{ route('student.mylearnings') }}" class="btn btn-primary">
                                    Reset
                            ...
                            @foreach ($learnings as $learning)
                                <tr>
                                    ...
                                    @if ($learning->content_description)
                                        <td class="text-wrap">
                                            <div class="text-center">{{ $learning->content_description }}&nbsp;
                                                @if ($learning->content_link)
                                                    <a class="badge bg-primary"
                                                        href="{{ url('uploads/documents/learningcontents') }}/{{ $learning->content_link }}"
                                                        target="_blank"><b>View</b></a>
                                                @endif
                                            </div>
                                        </td>
                                    @else
                                    ...
                                    @if ($learning->video_description)
                                        <td class="text-wrap">
                                            <div class="text-center">{{ $learning->video_description }}&nbsp;
                                                @if ($learning->video_link)
                                                    <a class="badge bg-primary"
                                                        href="{{ url('uploads/videos/learningcontents') }}/{{ $learning->video_link }}"
                                                        target="_blank"><b>View</b></a>
                                                @endif
                                            </div>
                                        </td>
                                    ...
                                    @if ($learning->blog_description)
                                        <td class="text-wrap">
                                            <div class="text-center">{{ $learning->blog_description }}&nbsp;
                                                <a class="badge bg-primary"
                                                    href="{{ $learning->blog_link }}"><b>View</b></a>
    ...
    <div class="modal fade" id="studyMaterialModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe width="100%" height="500px" src="studyMaterial/10_maths_key_notes_ch_01_real_numbers.pdf"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen></iframe>
