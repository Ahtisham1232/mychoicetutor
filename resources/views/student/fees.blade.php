    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="{{ route('student.payments-search') }}" method="GET">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="{{ route('student.payments-search') }}" class="btn btn-primary rounded-pill px-4 me-3">
                        ...
                        <tbody>
                            ...
                            @foreach ($payments as $payment)
                                <tr>
                                    ...
                                    <td><a href="#" class=""
                                            onclick="showinvoice('{{ $payment->paymentdetails_id }}')">
                                            {{ $payment->transaction_id }}</a></td>
