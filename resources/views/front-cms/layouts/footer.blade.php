        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                ...
                <ul class="contactDetail" style="margin-left:2px; list-style: none; padding: 0;">
                    ...
                    <li class="contact-item">
                        <a href="mailto:mychoicetutor@gmail.com" style="display: flex; align-items: center; gap: 10px; color: inherit; text-decoration: none;">
                            ...
                            <span>mychoicetutor@gmail.com</span>
                        </a>
                    </li>
                </ul>
