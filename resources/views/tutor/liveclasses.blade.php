                                ...
                                <tr>
                                    ...
                                    <td class="btns gap-2 text-nowrap">
                                        ...
                                        onclick="warningModal('{{ $liveclass->liveclass_id }}','{{ $liveclass->start_url }}')"><span
                                            ...
                                            <button class="btn btn-sm btn-success"
                                                onclick="warningModal('{{ $liveclass->liveclass_id }}','{{ $liveclass->start_url }}')">
                                                <span class="fa fa-play-circle "></span> Launch Class
                                            </button>
                                        @endif
                                        @if ($liveclass->status == 'started' || $liveclass->status == 'Started')
                                            <button class="btn btn-sm btn-primary"
                                                onclick="openMarkModal({{ $liveclass->liveclass_id }}, '{{ $liveclass->recording_link }}', '{{ $liveclass->topics }}');"><span
                                                    class="fa fa-check "></span> Mark Completed</button>
                                        @endif
                                        @if (isset($liveclass->recording_link) && $liveclass->recording_link)
                                            @php
                                                $recordingUrl = filter_var(
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <h4 class="">Please Make Sure To Start The
                                <span style="color: red">
                                    <i class="ri-record-circle-fill"></i> Recording</span>
                            </h4>
                            <br>
                            <p class=""><span class="text-primary"><b>Hint To Start Recording :</b></span> <br>Step
                                1: Start
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Mark Class as Completed</h5>
                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Topic Here"
                                            id="video_topic" name="video_topic" required>
                                    </div>
                                </div>
                                <!-- Video Link Input -->
                                {{-- <div class="row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="student_status"
                                                id="studentPresent" value="present" required>
                                            <label class="form-check-label" for="studentPresent">Present</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="student_status"
                                                id="studentAbsent" value="absent" required>
                ...
                $.ajax({
                    ...
                    success: function(dataResult) {
                        try {
                            ...
                            <button onclick="launchClass('${link}')" class="btn btn-sm btn-success">Ok</button>
                        `;
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            if (xhr.responseJSON && xhr.responseJSON.errors) {
                                ...
                                toastr.error(
                                "Something went wrong (liveclass). Please try again.");
