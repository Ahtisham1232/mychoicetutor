                    ...
                    <form action="{{ route('tutor.slots.search') }}" method="GET">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 mb-2">
                                <select type="text" class="form-control" style="width:100%" id="selectsubject"
                                    name="selectsubject">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 mb-2">
                                <select type="text" class="form-control" sstyle="width:100%" id="selectstudent"
                                    name="selectstudent">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 mb-2">
                                <select type="text" class="form-control" style="width:100%" id="bookingstatus"
                                    name="bookingstatus">
                            ...
                            {{-- <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 mb-2">
                                <input type="date" class="form-control" style="width:100%" onchange="searchSlots();"
                                    id="searchDate" name="searchDate">
                            </div> --}}

                            <div class="col-lg-4 col-md-8 col-sm-12 mb-2">
                                <div class="d-flex align-items-center h-100">
                                    <button class="btn rounded-pill px-4 me-2 text-white" type="submit" style="background-color: #43518c; border: none; white-space: nowrap;">
                                        <i class="ri-calendar-todo-fill"></i> Search Slot
                                    </button>

                                    <a href="{{route('tutor.tutorslots')}}" class="btn rounded-pill px-4 text-white" style="background-color: #43518c; border: none; white-space: nowrap;">
                        ...
                        <tbody>
                            ...
                            @elseif ($slot->status == 2) --}}
                                <tr>
                                    ...
                                    @elseif ($slot->status == 2)
                                        <td><span class="text-muted small">Waiting for admin to approve enrollment</span>
                                        </td>
                                    @else
                                        <td>
                                            @if ($slot->is_class_scheduled == 1)
                                                <a href="/tutor/getclasslist"><button
                                                        class="btn btn-sm btn-success bookingBtns">Start
                                                        Class</button></a>
                                        </td>
                                    @elseif ($slot->is_class_scheduled == 2)
                                    @else
                                        <button
                                            ...
                                            class="btn btn-sm btn-success bookingBtns"><i
                                        ...
                                        <button
                                            ...
                                            class="btn btn-sm btn-warning bookingBtns"><i
                                                class="ri-calendar-todo-fill"></i>
                                            &nbsp;Modify Class</button>
                                        </td>
                                    @endif
