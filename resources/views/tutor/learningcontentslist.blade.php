...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    @endif
        <div id="" class="mb-3 listHeader page-title-box">
            ...
            <a href="{{route('tutor.learningcontents.add')}}"><button class="btn btn-sm btn-success"> <span class="fa fa-plus"></span> Add Content</button></a>
        </div>
            ...
            <table class="table table-hover table-striped align-middlemb-0 users-table">
                ...
                @foreach ($contents as $content)
                    <tr>
                        ...
                        <td><a href="{{route('tutor.learningcontents.edit', $content->contentid)}}"><button class="badge bg-danger">Modify</button></a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
