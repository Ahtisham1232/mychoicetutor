                    ...
                    <div class="form-group mt-5">
                        ...
                        <div class="col-md-2 d-flex align-items-end justify-content-end">
                            <div class="form-group d-flex gap-2">
                                ...
                                <a href="{{ route('admin.reports.student-payments') }}" class="btn btn-secondary">
                ...
                <table class="table table-hover table-striped align-middlemb-0 table-responsive">
                    ...
                    <tbody>
                        @foreach ($payments as $payment)
                            <tr>
                                <td>{{ $loop->iteration }}
                                <td><a href="studentprofile/{{ $payment->student_id }}">{{ $payment->student_name }}</a>
                                </td>
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('admin.payments.update') }}" method="POST">
                                    ...
                                    <div class=" row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="transactionno"
                                                name="transactionno" disabled>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Student Name</label>
                                            <input type="text" class="form-control" id="studentname"
                                                name="studentname" disabled>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="">Payment Status<i style="color:red">*</i></label>
                                            <select type="text" class="form-control" id="paymentstatus"
                                    ...
                                    <button type="submit" id=""
                                        class="btn btn-sm btn-primary float-right"><span class="fa fa-check"></span>
                                        Update</button>
